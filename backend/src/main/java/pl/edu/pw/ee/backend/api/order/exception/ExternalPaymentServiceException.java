...
public class ExternalPaymentServiceException extends AbstractException {

    @Serial
    private static final long serialVersionUID = 4999326098476352822L;
    private static final String ORDER_NOT_FOUND_EXCEPTION_MESSAGE = "Cannot pay for order with id %d.";

    public ExternalPaymentServiceException(int id) {
